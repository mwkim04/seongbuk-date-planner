...
/* 슬라이더: 채워진 부분의 기본 빨강을 핑크로. 형식(rgb/hex/그라데이션) 무관하게 강제 */
...
/* 체크된 체크박스의 기본 빨강 박스/테두리를 핑크로 (형식 무관 강제) */
[data-testid="stCheckbox"] [style*="255, 75, 75"],
[data-testid="stCheckbox"] [style*="255,75,75"],
[data-testid="stCheckbox"] [style*="rgb(255, 75, 75)"],
[data-testid="stCheckbox"] [style*="rgb(255,75,75)"],
[data-baseweb="checkbox"] [style*="255, 75, 75"],
[data-baseweb="checkbox"] [style*="255,75,75"],
