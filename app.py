...
/* 기본 빨간 포인트만 핑크로: 사이드바 슬라이더/체크박스 한정 */
section[data-testid="stSidebar"] [data-testid="stSlider"] [style*="rgb(255, 75, 75)"],
section[data-testid="stSidebar"] [data-testid="stSlider"] [style*="rgb(255,75,75)"],
section[data-testid="stSidebar"] [data-testid="stSlider"] [style*="#ff4b4b"],
section[data-testid="stSidebar"] [data-testid="stSlider"] [style*="#FF4B4B"],
...
with st.sidebar:
    ...
    with st.form("condition_form", clear_on_submit=False):
        ...
        moods = st.multiselect("분위기 키워드", ["감성", "조용한", "활동적", "레트로", "가성비"], default=["감성", "조용한"])
